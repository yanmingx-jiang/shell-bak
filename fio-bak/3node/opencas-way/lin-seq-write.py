...
node1 = subprocess.Popen("ssh root@192.168.10.2 'fio seq-write-libaio.fio' > out/node1-seq-write.fio.out 2>&1 &", shell=True, stdout=subprocess.PIPE)

node2 = subprocess.Popen("ssh root@192.168.10.3 'fio seq-write-libaio.fio' > out/node2-seq-write.fio.out 2>&1 &", shell=True, stdout=subprocess.PIPE)

# node3 = subprocess.Popen("ssh root@192.168.10.4 'fio seq-write-libaio.fio' > out/node3-seq-write.fio.out 2>&1 &", shell=True, stdout=subprocess.PIPE)
